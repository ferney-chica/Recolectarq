...
$sql="INSERT INTO `imagenes_perfil_expuesto`(`imagen_perfil_expuesto_id`, `estratos_perfiles_estrato_perfil_id`, `perfiles_expuestos_perfil_expuesto_id`, `tipo`, `nombre`) VALUES (NULL,NULL,'{$perfil_id}','{$tipo}','{$nombre}')";
