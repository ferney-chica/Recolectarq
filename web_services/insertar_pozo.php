...
$conexion=mysqli_connect($hostname,$username,$password,$database);
    ...
    $codigo_rotulo=$_POST["codigo_rotulo"];
      ...
      $sql="INSERT INTO `pozos` (`pozo_id`, `umtp_id`, `descripcion`, `usuario_creador`, `usuario_encargado`, `codigo_rotulo`) VALUES (NULL, '{$umtp_id}', '{$descripcion}', '{$usuario_creador}', '{$usuario_encargado}', '{$codigo_rotulo}')";
