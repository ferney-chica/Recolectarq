...
$sql="INSERT INTO `imagenes_materiales_recolecciones`(`imagen_material_recoleccion_id`, `materiales_recolecciones_material_recoleccion_id`, `nombre`) VALUES (NULL,'{$material_recoleccion_id}','{$nombre}')";
