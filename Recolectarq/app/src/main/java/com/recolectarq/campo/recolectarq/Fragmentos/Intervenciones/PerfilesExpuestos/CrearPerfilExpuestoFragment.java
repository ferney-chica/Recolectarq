...
public class CrearPerfilExpuestoFragment extends Fragment implements InicioUsuarioActivity.OnBackPressedListener{
    ...
    private Button btnCrearPerfilExpuesto;
    private RequestQueue request;
    private JsonRequest jrq;
    private ArrayList<PerfilesExpuestos> listaPerfilesExpuestos;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments()!=null)
        {
            ...
            System.out.println("El usuario CREADOR del PERFIL EXPUESTO: " + usuarioLogueado.getNombre() + "con cedula "+ usuarioCreadorPerfil+ " LA UMTP ES: "+ idUmtp);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       // return super.onCreateView(inflater, container, savedInstanceState);
        ...
        final View v= inflater.inflate(R.layout.fragment_crear_perfil_expuesto,container, false);
        ...
        btnCrearPerfilExpuesto=v.findViewById(R.id.buttonCrearPerfilExpuesto);
        btnCrearPerfilExpuesto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                {
                    codigoRotuloPerfil=editTextCodigoRotulo.getText().toString().trim();
                }

                if (editTextDescripcion.getText().toString().trim().isEmpty()){
                    Toast.makeText(getContext(),"Diligencie la descripción del perfil expuesto", Toast.LENGTH_LONG).show();
                }else{
                    webServiceInsertarPerfilExpuesto();
                }
   ...
   private void webServiceInsertarPerfilExpuesto() {
        ...
        String url=ip+"/web_services/insertar_perfil_expuesto.php?";
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.trim().equalsIgnoreCase("inserto")){
                    ...
                    Toast.makeText(getContext(),"No se ha insertado el perfil expuesto ",Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("usuario_creador",Integer.toString(usuarioCreadorPerfil));
                parametros.put("usuario_encargado",Integer.toString(usuarioCreadorPerfil));
                parametros.put("codigo_rotulo",codigoRotuloPerfil);
