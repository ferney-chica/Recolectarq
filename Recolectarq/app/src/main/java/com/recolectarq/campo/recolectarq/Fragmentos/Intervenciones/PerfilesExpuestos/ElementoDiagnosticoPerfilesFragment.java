...
public class ElementoDiagnosticoPerfilesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       // return super.onCreateView(inflater, container, savedInstanceState);
        ...
        View view= inflater.inflate(R.layout.fragment_elementos_diagnosticos_perfiles,container, false);
        ...
        consultarElementosDiagnosticosPerfiles();
    ...
    private void consultarElementosDiagnosticosPerfiles() {
        ...
        System.out.println("Id UMTP desde Service PERFILES"+idUmtp);
        String url=ip+"/web_services/buscar_elementos_diagnosticos_perfiles.php?umtp_id="+idUmtp;
        ...
        jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                JSONArray json=response.optJSONArray("elementos_diagnosticos_perfiles");
                ...
                try {
                    ...
                    mAdapter=new AdapterElementoDiagnostico("perfil",listElementos, R.layout.recycler_view_elemento_diagnostico, new AdapterElementoDiagnostico.OnItemClickListener() {
                        @Override
