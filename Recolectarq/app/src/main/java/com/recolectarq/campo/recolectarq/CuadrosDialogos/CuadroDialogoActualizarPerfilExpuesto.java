...
public class CuadroDialogoActualizarPerfilExpuesto {
    ...
    private PerfilesExpuestos perfilEnviado;
    ...
    {
        void PerfilActualizado(PerfilesExpuestos perfil);
    }


    public CuadroDialogoActualizarPerfilExpuesto(final Context contexto, final Proyectos proyectoSeleccionado, PerfilesExpuestos perfil, final FinalizarCuadroDialogo actividad) {
     interfaz=actividad;
        ...
        dialogoRecoleccion.setContentView(R.layout.cuadro_dialogo_editar_perfil_expuesto);
        ...
        textViewActualizarRecoleccionId.setText(textViewActualizarRecoleccionId.getText()+" "+perfilEnviado.getPerfil_expuesto_id());
        textViewActualizarRecoleccionUmtp.setText(textViewActualizarRecoleccionUmtp.getText()+" "+perfilEnviado.getUmtp_id());
        editTextActualizarRecoleccionCodigoRotulo.setText(perfilEnviado.getCodigo_rotulo());
        editTextActualizarRecoleccionDescripcion.setText(perfilEnviado.getDescripcion());
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.trim().equalsIgnoreCase("actualiza")){
                    ...
                    perfilEnviado.setDescripcion(editTextActualizarRecoleccionDescripcion.getText().toString());
                    perfilEnviado.setCodigo_rotulo(editTextActualizarRecoleccionCodigoRotulo.getText().toString());
                      interfaz.PerfilActualizado(perfilEnviado);
                }else{
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("recoleccion_superficial_id",perfilEnviado.getPerfil_expuesto_id()+"");
